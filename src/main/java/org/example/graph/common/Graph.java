...
public class Graph {
    ...
    public int n(){ return idToName.size(); }
    public List<Edge> out(int u){ return adj.get(u); }
    public String name(int id){ return idToName.get(id); }
    public Integer id(String name){ return nameToId.get(name); }
