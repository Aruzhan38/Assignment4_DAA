...
public class SimpleMetrics implements Metrics {
    ...
    @Override public void inc(String key, long by){ counters.merge(key, by, Long::sum); }
    @Override public long get(String key){ return counters.getOrDefault(key,0L); }
    @Override public void timeStart(String key){ t0.put(key, System.nanoTime()); }
    @Override public void timeEnd(String key){ dt.put(key, System.nanoTime() - t0.getOrDefault(key,0L)); }
    @Override public long nanos(String key){ return dt.getOrDefault(key,0L); }
